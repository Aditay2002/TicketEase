    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
         ...
         AppTicketTabs(firstTab:"Airlines",secondTab: "Hotels",),
          ...
          Gap(AppLayout.getHeight(25)),
          Container(
            padding: EdgeInsets.symmetric(horizontal: AppLayout.getWidth(18), vertical: AppLayout.getHeight(15)),
                    ...
                    Container(
                      ...
                      decoration:  BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit:BoxFit.cover,
                          image: AssetImage("assets/images/david-marcu-78A265wPiO4-unsplash.jpg")
                        ),
                      ),
                    ),
                    Gap(AppLayout.getHeight(15)),
                   ...
                   Container(
                       ...
                       child:Column(
                           ...
                           children:[
                             ...
                             Text("Take the survey about our service", style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.w500,color:Colors.white,fontSize: 18),)
                           ]
                       )
                   ),
                   Positioned(
